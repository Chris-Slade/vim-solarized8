...
" Last Updated: Mon May 20 11:28:13 2024
...
if &background ==# 'dark'
  ...
  if get(g:, 'solarized_visibility', '') ==# 'high'
    ...
    hi SpellBad guifg=NONE guibg=#fdf6e3 guisp=#dc322f gui=reverse,undercurl cterm=reverse,underline
    hi SpellCap guifg=NONE guibg=#fdf6e3 guisp=#dc322f gui=reverse,undercurl cterm=reverse,underline
    hi SpellLocal guifg=NONE guibg=#fdf6e3 guisp=#dc322f gui=reverse,undercurl cterm=reverse,underline
    hi SpellRare guifg=NONE guibg=#fdf6e3 guisp=#dc322f gui=reverse,undercurl cterm=reverse,underline
  ...
  elseif get(g:, 'solarized_visibility', '') ==# 'low'
    ...
    hi SpellBad guifg=NONE guibg=NONE guisp=#6c71c4 gui=undercurl ctermfg=NONE ctermbg=NONE cterm=underline
    hi SpellCap guifg=NONE guibg=NONE guisp=#6c71c4 gui=undercurl ctermfg=NONE ctermbg=NONE cterm=underline
    hi SpellLocal guifg=NONE guibg=NONE guisp=#b58900 gui=undercurl ctermfg=NONE ctermbg=NONE cterm=underline
    hi SpellRare guifg=NONE guibg=NONE guisp=#2aa198 gui=undercurl ctermfg=NONE ctermbg=NONE cterm=underline
  ...
  elseif get(g:, 'solarized_statusline', '') ==# 'flat'
    ...
    hi StatusLine guifg=#93a1a1 guibg=#073642 gui=NONE cterm=NONE
    hi StatusLineNC guifg=#586e75 guibg=#073642 gui=NONE cterm=NONE
    hi TabLine guifg=#839496 guibg=#073642 gui=underline cterm=underline
    hi TabLineFill guifg=#839496 guibg=#073642 gui=underline cterm=underline
    hi TabLineSel guifg=#586e75 guibg=#eee8d5 gui=reverse,underline cterm=reverse,underline
    hi VertSplit guifg=NONE guibg=#073642 gui=NONE cterm=NONE
  endif
  ...
  hi Delimiter guifg=#657b83 guibg=NONE gui=NONE cterm=NONE
  ...
  hi Operator guifg=#839496 guibg=NONE gui=NONE cterm=NONE
  hi PreProc guifg=#cb4b16 guibg=NONE gui=NONE cterm=NONE
  hi Special guifg=#268bd2 guibg=NONE gui=NONE cterm=NONE
  ...
  hi User1 guifg=#eee8d5 guibg=#002b36 gui=NONE cterm=NONE
  hi User2 guifg=#2aa198 guibg=#073642 gui=NONE cterm=NONE
  hi User3 guifg=#839496 guibg=#002b36 gui=NONE cterm=NONE
  hi User4 guifg=#859900 guibg=#073642 gui=NONE cterm=NONE
  hi User5 guifg=#dc322f guibg=#073642 gui=NONE cterm=NONE
  if !s:italics
  ...
  if get(g:, 'solarized_visibility', '') ==# 'high'
    ...
    hi SpellBad guifg=NONE guibg=#fdf6e3 guisp=#6c71c4 gui=reverse,undercurl cterm=reverse,underline
    hi SpellCap guifg=NONE guibg=#fdf6e3 guisp=#6c71c4 gui=reverse,undercurl cterm=reverse,underline
    hi SpellLocal guifg=NONE guibg=#fdf6e3 guisp=#cb4b16 gui=reverse,undercurl cterm=reverse,underline
    hi SpellRare guifg=NONE guibg=#fdf6e3 guisp=#cb4b16 gui=reverse,undercurl cterm=reverse,underline
    hi Title guifg=#cb4b16 guibg=NONE gui=bold cterm=bold
  elseif get(g:, 'solarized_visibility', '') ==# 'low'
    if get(g:, 'solarized_old_cursor_style', 0)
      hi Cursor guifg=#fdf6e3 guibg=#657b83 gui=NONE cterm=NONE
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    if get(g:, 'solarized_visibility', '') ==# 'high'
      ...
      hi SpellBad ctermfg=NONE ctermbg=230 cterm=reverse,underline
      hi SpellCap ctermfg=NONE ctermbg=230 cterm=reverse,underline
      hi SpellLocal ctermfg=NONE ctermbg=230 cterm=reverse,underline
      hi SpellRare ctermfg=NONE ctermbg=230 cterm=reverse,underline
    ...
    elseif get(g:, 'solarized_statusline', '') ==# 'flat'
      ...
      hi TabLine ctermfg=246 ctermbg=236 cterm=underline
      hi TabLineFill ctermfg=246 ctermbg=236 cterm=underline
      hi TabLineSel ctermfg=242 ctermbg=254 cterm=reverse,underline
      hi VertSplit ctermfg=NONE ctermbg=236 cterm=NONE
    endif
    ...
    hi User1 ctermfg=254 ctermbg=235 cterm=NONE
    hi User2 ctermfg=37 ctermbg=236 cterm=NONE
    hi User3 ctermfg=246 ctermbg=235 cterm=NONE
    hi User4 ctermfg=106 ctermbg=236 cterm=NONE
    hi User5 ctermfg=160 ctermbg=236 cterm=NONE
    if !s:italics
...
if s:t_Co >= 16
  if &background ==# 'dark'
    ...
    if get(g:, 'solarized_visibility', '') ==# 'high'
      ...
      hi SpellBad ctermfg=NONE ctermbg=15 cterm=reverse,underline
      hi SpellCap ctermfg=NONE ctermbg=15 cterm=reverse,underline
      hi SpellLocal ctermfg=NONE ctermbg=15 cterm=reverse,underline
      hi SpellRare ctermfg=NONE ctermbg=15 cterm=reverse,underline
    ...
    elseif get(g:, 'solarized_statusline', '') ==# 'flat'
      ...
      hi TabLine ctermfg=12 ctermbg=0 cterm=underline
      hi TabLineFill ctermfg=12 ctermbg=0 cterm=underline
      hi TabLineSel ctermfg=10 ctermbg=7 cterm=reverse,underline
    ...
    hi Ignore ctermfg=NONE ctermbg=NONE cterm=NONE
    hi Operator ctermfg=12 ctermbg=NONE cterm=NONE
    ...
    hi User1 ctermfg=7 ctermbg=8 cterm=NONE
    hi User2 ctermfg=6 ctermbg=0 cterm=NONE
    hi User3 ctermfg=12 ctermbg=8 cterm=NONE
    hi User4 ctermfg=2 ctermbg=0 cterm=NONE
    hi User5 ctermfg=1 ctermbg=0 cterm=NONE
    if !s:italics
      hi Comment cterm=NONE
    endif
    if has('nvim')
